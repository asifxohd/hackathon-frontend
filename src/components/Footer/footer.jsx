...
const Footer = () => {
	return (
		<footer className="bg-gray-800 text-gray-300 p-12">
			<div className="container  flex flex-wrap justify-between">
				...
				<div className='flex' >
					<div className="w-full  px-4 mb-8">
						<h2 className="text-xl font-semibold mb-4">Crisis Chat</h2>
			...
			<div className="text-center mt-8">
				<p className="text-sm">&copy; 2024 Your Organization. All rights reserved.</p>
			</div>
		</footer>
	);
};
